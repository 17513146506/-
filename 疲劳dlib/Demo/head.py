...
# 加载人脸检测和姿势估计模型（dlib）
face_landmark_path = '../Modul/shape_predictor_68_face_landmarks.dat'
...
def main():
    ...
    while cap.isOpened():
        ret, frame = cap.read()
        if ret:
            face_rects = detector(frame, cv2.COLOR_BGR2RGB)
            ...
            if len(face_rects) > 0:
                ...
                print('pitch:{}, yaw:{}, roll:{}'.format(pitch, yaw, roll))    # pitch:点头 yaw：转头 roll:左右摇头
