...
predictor = dlib.shape_predictor('../Modul/shape_predictor_68_face_landmarks.dat')
...
# 用作计数器和100次EAR和，先计数50次的ear值，求平均作为阈值
testCount=0
sum=0
...
while True:
    ...
    for rect in rects:
        ...
        if testCount<100:
            testCount+=1
            sum+=ear
            cv2.putText(frame, "Please be patient", (30, 250), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
            cv2.putText(frame, "Now,It is getting the threshold of your eye aspect ratio", (30, 300), cv2.FONT_HERSHEY_SIMPLEX,1, (0, 0, 255), 2)
            continue
        elif testCount==100:
            testCount+=1
            EYE_AR_THRESH = sum/100
            ...
            cv2.putText(frame, "EYE_AR_THRESH(100): {:.2f}".format(EYE_AR_THRESH), (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
