...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def window_init(self):
        ...
        self.label.setText("请点击左上角“打开字样”打开摄像头")
        self.label.setStyleSheet('''background: rgba(255, 255, 255, 80); 
                       font-family: YouYuan;
                       font-size: 23pt;
                       color: red;
                       ''')
        ...
        self.label_2.setStyleSheet('''background: rgba(255, 255, 255, 100); 
                               font-family: YouYuan;
                               font-size: 10pt;
                               color: red;
                               ''')
        self.label_3.setText("眨眼次数：0")
        self.label_3.setStyleSheet('''background: rgba(255, 255, 255, 100); 
                                      font-family: YouYuan;
                                      font-size: 10pt;
                                      color: red;
                                      ''')
        self.label_4.setText("哈欠次数：0")
        self.label_4.setStyleSheet('''background: rgba(255, 255, 255, 100); 
                                      font-family: YouYuan;
                                      font-size: 10pt;
                                      color: red;
                                      ''')
        self.label_5.setText("行为检测：")
        self.label_5.setStyleSheet('''background: rgba(255, 255, 255, 100); 
                                      font-family: YouYuan;
                                      font-size: 10pt;
                                      color: black;
                                      ''')
        self.label_6.setText("手机")
        self.label_6.setStyleSheet('''background: rgba(255, 255, 255, 100); 
                                      font-family: YouYuan;
                                      font-size: 10pt;
                                      color: black;
                                      ''')
        self.label_7.setText("抽烟")
        self.label_7.setStyleSheet('''background: rgba(255, 255, 255, 100); 
                                      font-family: YouYuan;
                                      font-size: 10pt;
                                      color: black;
                                      ''')
        self.label_8.setText("喝水")
        self.label_8.setStyleSheet('''background: rgba(255, 255, 255, 100); 
                                      font-family: YouYuan;
                                      font-size: 10pt;
                                      color: black;
                                      ''')
        self.label_9.setText("是否存在分心行为")
        self.label_9.setStyleSheet('''background: rgba(255, 255, 255, 100); 
                                      font-family: YouYuan;
                                      font-size: 10pt;
                                      color: black;
                                      ''')
        self.label_10.setText("是否为疲劳状态")
        self.label_10.setStyleSheet('''background: rgba(255, 255, 255, 100); 
                                      font-family: YouYuan;
                                      font-size: 10pt;
                                      color: red;
                                      ''')
    ...
    def show_pic(self):
        ...
        if success:
            ...
            if Roll == 100:
                ...
                perclos = (Rolleye/Roll) + (Rollmouth/Roll)*0.2
                # 在前端UI输出perclos值
                Ui_MainWindow.printf(window,"过去100帧中，Perclos得分为"+str(round(perclos,3)))
